...
import br.com.fiap.profit.models.RestValidationError;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<List<RestValidationError>> MethodArgumentoNotValidExceptionHandler(MethodArgumentNotValidException e){
